document.addEventListener("DOMContentLoaded", (event) => {
    ...
    function removerAtividade(id) {
        ...
        if (confirm("Tem certeza que deseja apagar este item?")) {// recebe id (number)
    ...
    function carregarAtividadesNaTela() {
        ...
        `;
            ...
            botaoConcluir.onclick = function () {
                ...
                if (index !== -1) { listaAtividadesStorage[index].concluida = isConcluida; // Salva o novo estado
    ...
    function alternarPainel(idPainelAlvo) {
        ...
        const estaExpandido = painelAlvo && painelAlvo.style.width === 'calc(100vw - 60px)';
    ...
    calendar = new FullCalendar.Calendar(document.getElementById('calendar-fullscreen'), {
